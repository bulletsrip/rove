...
live.src = `http://${location.hostname}:6080/rove.html?host=${encodeURIComponent(location.hostname)}&port=6080&path=websockify&scale=true&view_only=true&theme=${liveTheme()}`;
