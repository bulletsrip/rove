...
RUN apt-get update && apt-get install -y --no-install-recommends chromium xvfb x11vnc fluxbox novnc websockify ca-certificates x11-xserver-utils && rm -rf /var/lib/apt/lists/*
WORKDIR /app
