...
def choose(state, goal, history, continuation_context=None, run_history_start=0):
    ...
    if last_action and last_action.get("page_changed") is False:
        request_state["no_progress"] = {
            ...
            "instruction": "The last action produced no observable page change; re-plan instead of repeating it automatically.",
        }
...
def field_text(context):
    ...
    try:
        value = parse_text_response(result["choices"][0]["message"]["content"])
